            ...
            <Flex width='full' align='center' justifyContent='center'>
                ...
                >
                    ...
                    <Box textAlign='center' mb={8}>
                        {isAdmin ? (
                            <Text>
                                Invite a new player so that he could start an
                                amazing journey in tournament and playing
                                against people from all over the world!
                            </Text>
                        ) : (
                            <Text>
                                Create an account to start your amazing journey
                                in tournament and playing against people from
                                all over the world!
                            </Text>
                        )}
                    </Box>
