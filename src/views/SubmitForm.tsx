...
const SubmitForm = () => {
    ...
    const handleSubmit = async (values: any, actions: any) => {
        const request: GameResult = {
            ...values,
            winningPower:
                values.winningPower !== 'Tie' ? values.winningPower : null,
            playerBlueId:
            ...
            <Flex width='full' align='center' justifyContent='center'>
                ...
                >
                    ...
                    <Box textAlign='center' mb={8}>
                        <Text>
                            Please use this form to report the result of a game.
                            You can report results for games only, where you
                                ...
                                <Form>
                                    ...
                                    <Field name='identifier'>
                                        {({ form, field }: any) => (
                                            ...
                                            >
                                                <FormLabel>
                                                    Check ID: For ITSL, RTSL
                                                    ,OTSL and RATS , check it in
                                                    Schedule. French League:
                                                    F000. LFTS: E000. Greek
                                                    League: G000. British
                                                    League: U000. KTSL: K000.
                                                    Liga Portuguesa: P000.
                                                    Euskal Liga: B000. Lliga
                                                    Catalana: C000. Dutch
                                                    League: D000. Belgian
                                                    League: B100. Illinois
                                                    League I000. Hong Kong Cup:
                                                    H000. Italian League I100.
                                                    Polish League P100. Atlantic
                                                    Coast League: A000. Nordic
                                                    Cup: N000. Texas League:
                                                    T000. Pacific League: P200.
                                                    Canadian League : C100 .
                                                    Israel League I200 . Chinese
                                                    League : C200 Any other
                                                    game: 0000.
                                                </FormLabel>
                                                <Input
